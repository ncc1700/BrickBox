...
private:
    ...
    void loadFace(PreResolved &pre_resolved, const nlohmann::json &faces, const std::string &name, const std::array<glm::vec3, 4> &points, const glm::vec4& default_uv) const;
